<template>
	<div class="position-relative w-100 py-4 section-inspirations">
		<img v-bind:src="require('../assets/section_one.jpeg')" alt="Hero Image" class="position-absolute w-100 h-100">
		...
		<div class="position-absolute w-100 icon">
			<svg class="w-100 h-100" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100" height="115.471" viewBox="0 0 100 115.471">
				<defs>
